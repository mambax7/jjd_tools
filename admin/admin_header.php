...
if ( $xoopsUser ) {
	$xoopsModule = XoopsModule::getByDirname(_JJD_DIR_NAME);
	if ( !$xoopsUser->isAdmin($xoopsModule->mid()) ) {
		redirect_header(XOOPS_URL."/",3,_AD_JJD_NOPERM);
    exit();
	}
} else {
	redirect_header(XOOPS_URL."/",3,_AD_JJD_NOPERM);
...
//include_once ('../include/lexique_constantes.php');
...
include_once (_JJD_JJD_PATH.'include/html_functions.php');
include_once (_JJD_JJD_PATH.'include/editor_functions.php');
include_once (_JJD_JJD_PATH.'include/strbin_function.php');

include_once (_JJD_JJD_PATH.'include/adminOnglet/adminOnglet.php');
include_once (_JJD_JJD_PATH.'include/spin/spin.php');
//----------------------------------------------------------------
