...
//-------------------------------------------------------------
$vars = array(array('name' =>'op',        'default' => 'jjd_tools'),
...
*****************************************************************************/
   ...
   admin_xoops_cp_header(_JJD_ONGLET_DOC + $gepeto['numDoc'], $xoopsModule);
   $tDoc = array('help/jjd_tools','licence/GPL'); 
...
//    viewDoc ($tDoc[$gepeto['numDoc']], $xoopsConfig['language'], _LEX_ROOT_PATH);
    ...
    viewDocFromSite ('jjd_tools', $tDoc[$gepeto['numDoc']], $xoopsConfig['language'], $root);  
